...
class FollowAdapter(private val users: List<User>, private val activity: AppCompatActivity) :
    ...
    override fun onBindViewHolder(holder: FollowViewHolder, position: Int) {
        ...
        activity.lifecycleScope.launch {
            ...
            Log.d("FollowAdapter", "isFollowing=$isFollowing → ${if (isFollowing) "following_button" else "follow_button"}")
